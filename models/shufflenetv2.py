...
class ShuffleNetV2_32(nn.Module):
    def __init__(
        self,
        ...
        super(ShuffleNetV2_32, self).__init__()
...
def shufflenet_v2_x0_5_re(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ShuffleNetV2:
    """
    ...
    return _shufflenetv2('shufflenetv2_x0.5', pretrained, progress,
                         [3, 3, 3], [24, 48, 96, 192, 1024], **kwargs)
